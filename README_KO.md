...
고성능 애플리케이션을 위한 포괄적인 모니터링, 분산 추적 및 신뢰성 기능을 제공하는 프로덕션 준비 완료 C++17 관찰성 플랫폼입니다. 원활한 생태계 통합을 위한 모듈식 인터페이스 기반 아키텍처로 구축되었습니다.

**핵심 가치 제안**:
- **성능 우수성**: 10M+ 메트릭 작업/초, <50ns 컨텍스트 전파
- **프로덕션급 신뢰성**: 스레드 안전 설계, 포괄적인 오류 처리, circuit breaker
